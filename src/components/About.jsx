  ...
  >
    ...
    <div className="w-full md:w-1/2 relative p-6 md:p-8">
      ...
      <p
        ...
        "
      >
        Kenyi Asencios, el Chef Tilico, con una pasión inigualable por la cocina
        y los procesos artesanales, comenzó esta aventura trabajando con masas madre
        y fermentaciones naturales.  
        <br /><br />
        Hoy desarrolla una variedad de panes de larga fermentación,
        elaborados con una masa madre activa desde el 2022,
        cuidada día a día como el corazón de Tilico.
      </p>
    </div>
